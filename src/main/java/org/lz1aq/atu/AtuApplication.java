...
public class AtuApplication extends javax.swing.JFrame
{
  ...
  public AtuApplication()
  {
    ...
    tuneSettins = new TuneSettings(applicationSettings.NUMBER_OF_BAND_BUTTONS,
            applicationSettings.NUMBER_OF_ANT_BUTTONS,
            applicationSettings.NUMBER_OF_MODE_BUTTONS,
  ...
  private void initComponents()
  {
    ...
    jSliderC2.addChangeListener(new javax.swing.event.ChangeListener()
    {
      public void stateChanged(javax.swing.event.ChangeEvent evt)
      {
        jSliderC2StateChanged(evt);
      }
    });
